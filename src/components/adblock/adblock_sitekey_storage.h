...
#ifndef COMPONENTS_ADBLOCK_ADBLOCK_SITEKEY_STORAGE_H_
#define COMPONENTS_ADBLOCK_ADBLOCK_SITEKEY_STORAGE_H_
 ...
 */
class AdblockSitekeyStorage : public KeyedService {
 public:
  ...
  virtual void ProcessResponseHeaders(
      ...
      mojom::AdblockInterface::ProcessResponseHeadersCallback callback) = 0;
...
#endif  // COMPONENTS_ADBLOCK_ADBLOCK_SITEKEY_STORAGE_H_
