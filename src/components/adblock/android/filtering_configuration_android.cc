...
FilteringConfigurationAndroid::GetAllowedDomains(JNIEnv* env) const {
  return base::android::ToJavaArrayOfStrings(
      env, filtering_configuration_ptr->GetAllowedDomains());
}
...
FilteringConfigurationAndroid::GetCustomFilters(JNIEnv* env) const {
  return base::android::ToJavaArrayOfStrings(
      env, filtering_configuration_ptr->GetCustomFilters());
}
...
base::android::ScopedJavaLocalRef<jobjectArray>
FilteringConfigurationAndroid::GetFilterLists(JNIEnv* env) const {
...
JNI_FilteringConfiguration_GetAcceptableAdsUrl(JNIEnv* env) {
  return base::android::ConvertUTF8ToJavaString(
      env, adblock::AcceptableAdsUrl().spec());
}
