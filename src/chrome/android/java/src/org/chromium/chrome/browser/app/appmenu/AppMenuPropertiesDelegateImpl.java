...
public class AppMenuPropertiesDelegateImpl implements AppMenuPropertiesDelegate {
    ...
    private void preparePageMenu(
        ...
        Drawable iconExit = AppCompatResources.getDrawable(mContext, R.drawable.ic_exit_to_app_white_24dp);
        DrawableCompat.setTintList(iconExit,
                AppCompatResources.getColorStateList(
                        mContext, R.color.default_icon_color_tint_list));
        menu.findItem(R.id.preferences_exit).setIcon(iconExit);
