...
enum HistogramValue {
  ...
  // Adblock's below:
  ADBLOCKPRIVATE_SETENABLED = 5000,
  ADBLOCKPRIVATE_ISENABLED = 5001,
  ADBLOCKPRIVATE_SETUPDATECONSENT = 5002,
  ADBLOCKPRIVATE_GETUPDATECONSENT = 5003,
  ADBLOCKPRIVATE_SETACCEPTABLEADSENABLED = 5004,
  ADBLOCKPRIVATE_ISACCEPTABLEADSENABLED = 5005,
  ADBLOCKPRIVATE_ADDCUSTOMSUBSCRIPTION = 5006,
  ADBLOCKPRIVATE_REMOVECUSTOMSUBSCRIPTION = 5007,
  ADBLOCKPRIVATE_GETCUSTOMSUBSCRIPTIONS = 5008,
  ADBLOCKPRIVATE_GETBUILTINSUBSCRIPTIONS = 5009,
  ADBLOCKPRIVATE_SELECTBUILTINSUBSCRIPTION = 5010,
  ADBLOCKPRIVATE_UNSELECTBUILTINSUBSCRIPTION = 5011,
  ADBLOCKPRIVATE_GETSELECTEDBUILTINSUBSCRIPTIONS = 5012,
  ADBLOCKPRIVATE_ADDALLOWEDDOMAIN = 5013,
  ADBLOCKPRIVATE_REMOVEALLOWEDDOMAIN = 5014,
  ADBLOCKPRIVATE_GETALLOWEDDOMAINS = 5015,
  ADBLOCKPRIVATE_ADDCUSTOMFILTER = 5016,
  ADBLOCKPRIVATE_REMOVECUSTOMFILTER = 5017,
  ADBLOCKPRIVATE_GETSESSIONALLOWEDADSCOUNT = 5018,
  ADBLOCKPRIVATE_GETSESSIONBLOCKEDADSCOUNT = 5019,
