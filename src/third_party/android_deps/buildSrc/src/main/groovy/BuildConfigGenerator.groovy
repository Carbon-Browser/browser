...
class BuildConfigGenerator extends DefaultTask {
    ...
    boolean excludeDependency(ChromiumDepGraph.DependencyDescription dependency) {
        ...
        boolean isAndroidxDependency = (dependency.id.startsWith('androidx')) && !(dependency.id.contains('androidx_work_work_runtime')) && !(dependency.id.contains('androidx_lifecycle_lifecycle_service'))
