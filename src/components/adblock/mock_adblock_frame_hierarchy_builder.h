...
#ifndef COMPONENTS_ADBLOCK_MOCK_FRAME_HIERARCHY_BUILDER_H_
#define COMPONENTS_ADBLOCK_MOCK_FRAME_HIERARCHY_BUILDER_H_
...
class MockFrameHierarchyBuilder
    : public testing::NiceMock<AdblockFrameHierarchyBuilder> {
 public:
...
#endif  // COMPONENTS_ADBLOCK_MOCK_FRAME_HIERARCHY_BUILDER_H_
