...
public class SyncPromoController {
    ...
    public boolean canShowSyncPromo() { return false;
        // switch (mAccessPoint) {
        //     case SigninAccessPoint.BOOKMARK_MANAGER:
    ...
    private boolean canShowNTPPromo() { return false;
        // int promoShowCount =
        //         ChromeSharedPreferences.getInstance()
        //                 .readInt(
        //                         getPromoShowCountPreferenceName(
    ...
    private boolean canShowBookmarkPromo() { return false;
        // boolean isPromoDismissed =
        //         ChromeSharedPreferences.getInstance()
    ...
    private boolean canShowRecentTabsPromo() { return false;
