...
public class ToolbarPhone extends ToolbarLayout implements OnClickListener, TabCountObserver {
    ...
    protected ChromeImageButton mRewardsButton;
    ...
    public void onFinishInflate() {
        try (TraceEvent te = TraceEvent.scoped("ToolbarPhone.onFinishInflate")) {
            ...
            mRewardsButton = findViewById(R.id.rewards_button);
    ...
    void drawTabSwitcherAnimationOverlay(Canvas canvas, float animationProgress) {
        ...
        // render rewards button
        // if (mRewardsButton != null) {
        //     previousAlpha = mRewardsButton.getAlpha();
        //     mRewardsButton.setAlpha(previousAlpha * floatAlpha);
        //     drawChild(canvas, mRewardsButton, SystemClock.uptimeMillis());
        //     mRewardsButton.setAlpha(previousAlpha);
        // }
    ...
    public void onHomeButtonUpdate(boolean homeButtonEnabled) {
        mIsHomeButtonEnabled = false;//homeButtonEnabled;
    ...
    public void onTintChanged(ColorStateList tint, boolean useLight) {
        ...
        // rewards button tint
        // ApiCompatibilityUtils.setImageTintList(mRewardsButton, tint);
