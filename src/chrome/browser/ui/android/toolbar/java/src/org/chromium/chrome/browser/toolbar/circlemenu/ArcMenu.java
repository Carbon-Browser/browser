...
import org.chromium.chrome.browser.toolbar.circlemenu.anim.AnimationObject;
import org.chromium.chrome.browser.toolbar.circlemenu.anim.ViewAnim;
import org.chromium.chrome.browser.toolbar.circlemenu.interfaces.ScrollDirectionListener;
import org.chromium.chrome.browser.toolbar.circlemenu.util.Util;
import org.chromium.chrome.browser.toolbar.circlemenu.widget.ArcLayout;
import org.chromium.chrome.browser.toolbar.circlemenu.widget.FloatingActionButton;
import org.chromium.chrome.browser.toolbar.circlemenu.widget.MoveUpwardBehavior;
...
public class ArcMenu extends RelativeLayout
	...
	private void applyAttrs(Context context, AttributeSet attrs) {
		if (attrs != null) {
			...
			mMenuGravity = b.getInt(R.styleable.ArcMenu_menuGravityCarbon,
					CENTER);
	...
	public void setMenuGravity(int gravity) {
		...
		switch (gravity) {
			...
			case BOTTOM_MIDDLE:
				setArcLayoutParam(ANIM_BOTTOM_TO_DOWN,
						Gravity.CENTER_HORIZONTAL | Gravity.BOTTOM, mFromDegree = 210, mToDegree = 330);
