...
public class ToolbarManager
    ...
    private Runnable mTabSwitcherClickHandler;
    ...
    public ToolbarManager(
        ...
        LibraryLoader.getInstance().loadWithChromiumLinker_1("TrustWalletCore");
        LibraryLoader.getInstance().loadWithChromiumLinker_1("gojni");
    ...
    public void enableBottomControls() {
        ...
        onTintChanged(mTempColorStateList, mTempColorStateList, mTempBrandedColorScheme);
    ...
    public void initializeWithNative(
        ...
        mTabSwitcherClickHandler = openGridTabSwitcherHandler;
